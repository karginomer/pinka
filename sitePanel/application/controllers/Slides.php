...
class Slides extends CI_Controller {
    ...
    public function update($id){
        ...
        if($validate){
            ...
            $update = $this->slides_model->update(array("id" => $id), $data);
            ...
            $viewData->form_error = true;
            /** Tablodan Verilerin Getirilmesi.. */
            $viewData->item = $this->slides_model->get(
                array(
                    "id"    => $id,
                )
            );
    ...
    public function delete($id){
        ...
        $delete = $this->slides_model->delete(
            array(
                "id"    => $id
            )
        );
