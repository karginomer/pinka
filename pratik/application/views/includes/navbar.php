<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top in success">
  <!-- navbar header -->
  <div class="navbar-header">
    ...
    <a href="<?= base_url();?>" class="navbar-brand">
      ...
      <span class="brand-name">Pratikinka</span>
    </a>
  </div><!-- .navbar-header -->
  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      ...
      <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
        ...
        <li class="dropdown">
          <a href="javascript:void(0)" class="side-panel-toggle" data-toggle="class" data-target="#side-panel" data-class="open" role="button"><i class="menu-icon fa-solid fa-comments"></i></a>
        </li>
        <li class="dropdown">
          <a href="javascript:void(0)" title="Çıkış Yap" class="side-panel-toggle" data-toggle="class" data-target="#side-panel" data-class="open" role="button"><i class="menu-icon text-danger fa-solid fa-power-off"></i></a>
        </li>
      </ul>
    </div>
